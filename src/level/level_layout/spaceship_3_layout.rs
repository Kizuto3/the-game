...
use super::{spaceship_2_layout::Spaceship2Info, DoorCollider, EntityInfo, FloorAssetType, FloorInfo, FloorModification, GravityInverter, LevelInfo, TransitionCollider};
            ...
            return Some(Box::from([
                NPC {
                    ...
                    conversation: &[
                        ...
                        ConversationEntry { position: ConversationPosition::Right, npc_name: MINAWAN, text: "Gravity seems all messed up in this room.", emotion: Emotion::Regular },
