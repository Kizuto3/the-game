        ...
        vec![
            NPC { floor_info: FloorInfo { position: Vec3::new(750.0, -300.0, 0.0), size: Vec2::new(200.0, 200.0) }, is_active: false, current_conversation_index: 0,
                conversation: vec![
                    ...
                    ConversationEntry { position: ConversationPosition::Left, npc_name: "cweampuff".to_string(), text: "Maybe Old Cweampuff knows something about this.".to_string(), emotion: Emotion::Regular },
                ],
