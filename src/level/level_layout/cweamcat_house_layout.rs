...
impl LevelInfo for CweamcatHouseInfo {
    ...
    fn get_npcs(&self, _cweampuff: &crate::Cweampuff) -> Option<Box<[NPC]>> {
        Some(Box::from([
            NPC { floor_info: EntityInfo { position: Vec3::new(750.0, -300.0, 0.0), size: Vec2::new(200.0, 200.0) }, is_active: false, current_conversation_index: 0,
                conversation: &[
                ...
                after_conversation_func: |cweampuff, _commands, _breakable_walls| { 
