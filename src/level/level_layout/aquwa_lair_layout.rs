    ...
    fn get_npcs(&self, cweampuff: &crate::Cweampuff) -> Option<Box<[NPC]>> {
        ...
        if cweampuff.progression == Progression::MilkWokeUp {
            ...
            og_crew_member.conversation = &[
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: OG_CREW_MEMBER, text: "The crew notified me about you.", emotion: Emotion::Regular },
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: OG_CREW_MEMBER, text: "We get to see all kinds of thing.", emotion: Emotion::Regular },
        ...
        let observer_crew_member = NPC { 
            ...
            conversation: &[
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: OBSERVER_CREW_MEMBER, text: "She always finds interesting thing all around the universe.", emotion: Emotion::Regular },
