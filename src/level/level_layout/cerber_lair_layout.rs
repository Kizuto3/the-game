    ...
    fn get_npcs(&self, cweampuff: &crate::Cweampuff) -> Option<Box<[NPC]>> {
        ...
        if cweampuff.progression == Progression::MetMilk {
            ...
            og_minawan.conversation = &[
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: OG_MINAWAN, text: "Together, we'd always make sure she knows how mush she is appreciated.", emotion: Emotion::Regular },
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: OG_MINAWAN, text: "However, more than ever before, you hidden gem needs you. All of you.", emotion: Emotion::Regular },
                ...
                ConversationEntry { position: ConversationPosition::Left, npc_name: CWEAMPUFF, text: "*** After going through Hell, seing how minawan love their rising star, and hearing their words of encouragment... ***", emotion: Emotion::Happy },
        ...
        let scientist_minawan = NPC { 
            ...
            conversation: &[
                ...
                ConversationEntry { position: ConversationPosition::Right, npc_name: SCIENTIST_MINAWAN, text: "Oh, I beg your pardon, I haven't noticed you.", emotion: Emotion::Regular },
